...
/** Same-origin path only (matches login.tsx). Reject protocol-relative //host. */
function safeSameOriginPath(path: string): string {
...
export async function signOut(redirectTo = "/"): Promise<void> {
  ...
  window.location.href = safeSameOriginPath(redirectTo);
}
