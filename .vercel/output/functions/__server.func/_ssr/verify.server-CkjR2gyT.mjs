...
import { n as auth, r as authConfigured } from "./server-ilFhfuWJ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/verify.server-CkjR2gyT.js
var verify_server_CkjR2gyT_exports = /* @__PURE__ */ __exportAll({
	n: () => verify_server_exports,
	t: () => DEV_USER_ID
});
...
//#endregion
export { verify_server_CkjR2gyT_exports as t };
