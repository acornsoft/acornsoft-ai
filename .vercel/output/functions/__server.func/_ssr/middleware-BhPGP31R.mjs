...
//#region node_modules/.nitro/vite/services/ssr/assets/middleware-BhPGP31R.js
/**
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	...
	const { requireUserId } = await import("./verify.server-CkjR2gyT.mjs").then((n) => n.t).then((n) => n.n);
