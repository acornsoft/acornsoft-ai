# Climb Notes writing style

**Audience:** people who use AI tools but do not live in tech jargon.  
**Standard:** plain language first. We are **not** claiming full [ASD-STE100](https://www.asd-ste100.org/) certification yet — we borrow its spirit (short sentences, common words, one idea at a time).  

**Public publish bar:** use the short **[STE checklist](./STE-CHECKLIST.md)** (approved verbs, max sentence length, term glossary). Path to true ASD-STE100 is outlined there.

---

## Purpose of a Climb Note
...
## Plain language rules (STE-inspired)

1. **One main idea per sentence.** Prefer two short sentences over one long one.
