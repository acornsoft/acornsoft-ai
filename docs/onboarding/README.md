...
**What Setup really does (all ridges):** deploys **`.github/`** skills and agents (Luna, BaseCamp, Route, Summit), writes **`.cursorrules`**, installs shell package to **`$HOME/etc`** when the bundle is present, then offers optional next actions (Install Grok Plugin, open Grok Build terminals, etc.).
